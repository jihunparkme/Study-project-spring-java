package example.concurrency.database.optimistic.controller;

import example.concurrency.database.optimistic.service.OptimisticLockStockFacade;
import example.concurrency.database.optimistic.service.OptimisticLockStockService;
...
public class OptimisticLockStockController {

    private final OptimisticLockStockFacade stockService;

    @GetMapping(value = "/buy/{id}/database/optimistic")
